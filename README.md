...
- The routes are dynamically generated by the structure of the templates. For example `/logistics/index.html => /logistics/`. See `dwebsummit_fontend/urls.py` to see the actual code. Note, regular routes can still be created like normal as well.
